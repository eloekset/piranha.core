...
namespace MvcWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddPiranhaAzureAD(azureADOptions =>
            {
                azureADOptions.Instance = @"https://login.microsoftonline.com/";
                azureADOptions.Domain = "[Enter the domain of your tenant, e.g. contoso.onmicrosoft.com]";
                azureADOptions.TenantId = "common";
                azureADOptions.ClientId = "Enter_the_Application_Id_here";
                azureADOptions.ClientSecret = "Enter_the_Client_Secret_here";
                azureADOptions.CallbackPath = @"/signin-iodc";
